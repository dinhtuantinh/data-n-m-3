		...
		<div id="header">
			...
			<div id="navigation">
				...
				<li><%=j%></li>
					...
					<li><input type="hidden" name="type" value="shoes"></input></li>
...
<select name="s_size"><option>6</option><option>6.5</option><option>7</option><option>7.5</option><option>8</option></select><br><br>
