...
<table><td>
Filter By Brand: &nbsp;&nbsp;<select name="brand"><option>--</option><option>Coach</option><option>Michael Kors</option></select>&nbsp;&nbsp;
<input type="submit" value="search"></td></table></form>
<br><br></br></br>
<%
String sql1="select i_brand,i_name,i_price,i_img from item where i_cat='bags'";
