...
<br></br>
	...
	<div align="center">
<body><form action="filter.jsp" method="get">
<table><td>
Filter By Brand: &nbsp;&nbsp;<select name="brand"><option>--</option><option>Forever21</option><option>Zara</option></select>&nbsp;&nbsp;
<input type="submit" value="search"></td></table></form>
<br><br></br></br>
<%
String sql1="select i_brand,i_name,i_price,i_img from item where i_cat='apparels'";
