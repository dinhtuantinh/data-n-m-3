		...
		<div id="header">
			...
			<div id="navigation">
				...
				<li><%=j%></li>
					...
					<li><input type="hidden" name="type" value="apparels"></input></li>
...
<input type="hidden" name="type" value="apparels">
...
<select name="s_size"><option>XSmall</option><option>Small</option><option>Medium</option><option>Large</option><option>XLarge</option></select><br><br>
